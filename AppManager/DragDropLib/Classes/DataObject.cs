...
namespace DragDropLib
{
	...
	public class DataObject : IDataObject, IDisposable
	{
		...
		public static void SetDropDescription(IDataObject dataObject, DropDescription dropDescription)
		{
			...
			try
			{
				...
				// Set the data
				IDataObject dataObjectCOM = (IDataObject)dataObject;
		...
		public static object GetManagedData(DataObject dataObject, string format)
		{
			FORMATETC formatETC;
			FillFormatETC(format, TYMED.TYMED_HGLOBAL, out formatETC);
	...
	//   public static Win32Point ToWin32Point(Point pt)
	//   {
